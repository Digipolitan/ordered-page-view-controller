# Contributing to ordered-page-view-controller
...
* **Did the problem start happening recently** (e.g. after updating to a new version of ordered-page-view-controller) or was this always a problem?
* If the problem started happening recently, **can you reproduce the problem in an older version of ordered-page-view-controller ?** What's the most recent version in which the problem doesn't happen? You can download older versions of ordered-page-view-controller from [the releases page](https://github.com/digipolitan/ordered-page-view-controller/releases).
* **Can you reliably reproduce the issue?** If not, provide details about how often the problem happens and under which conditions it normally happens.

Include details about your configuration and environment:

* **Which version of ordered-page-view-controller are you using?
...
#### Template For Submitting Bug Reports
    ...
    **ordered-page-view-controller version:** [Enter ordered-page-view-controller version here]
    ...
    * Problem started happening recently, didn't happen in an older version of ordered-page-view-controller: [Yes/No]
